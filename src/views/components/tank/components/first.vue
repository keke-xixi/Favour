<template>
    <div class="gamePass">
         <div class="top">
           ...
           <h1 class="gradient-text" style="color: #0bbde3;">第一关</h1>
  ...
  import { 
    FirstWall as MapList,
    // SecondWall as MapList,
    // ThirdWall as MapList,
    // FourthWall as MapList,
    // FifthWall as MapList,
    // SixthWall as MapList,
    // SeventhWall as MapList,
    // EighthWall as MapList,
    // NinthWall as MapList,
...
const props = defineProps({
  ...
  const goldNum = ref(9); // 本关金币数量
  const enemyNum = ref(1); // 本关敌人数量
