<template>
    <div class="mouse-game" ref="content" :style="mouseStyle">
        ...
        <div class="attack flex_c" :style="{
            ...
            <img :src="attack.img" class="img" style="width: 70%;height: 70%;" alt="">
        </div>
        <!-- 音频 -->
        <audio ref="audioB">
...
const handleKeyDown = (event:any) => {
    ...
    if(MOUSE_KEY['UP'].includes(event.key)){
       ...
       if(mouse.jumpState || mouse.jumpStateTwo) {
        ...
        mouse.img = mouse.direct === 'left' ? '/img/mouse/tx2.png' : '/img/mouse/tx1.png';
...
.mouse-game {
    width: 100%;
    height: 100vh;
    // background-color: #7168f4;
    background-color: #020202;
    position: relative;
    cursor: pointer;
    border: 2px solid #f19b01;
    color: #d7e9ee;
